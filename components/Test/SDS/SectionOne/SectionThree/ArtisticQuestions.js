...
export default function ArtisticQuestions({section_info}) {
  ...
  const category_info = section_info.category_info[2];
  ...
  function increament(params) {
    ...
    if (questionNumber === questionInfo.length){
        router.push('/test/section-three/social-questions')
  ...
  return (
    <div className=" w-96 bg-white p-4 rounded-lg border border-[#006592] border-opacity-25">
      <div>
