...
function Group_One(data) {
  ...
  const router = useRouter();
    ...
    //Questions
    const questions = data.data[3].category_info[0].question_info
    const section_name = data.data[3].title;
    const category_name = data.data[3].category_info[0].title;
                     ...
                     <div>
                        ...
                        <div className='space-x-2 py-1 w-full items-center flex justify-center '>
                            <button type={'button'} onClick={() => {
                                increament()
                                option_0()
                            }} className='border-2 rounded-xl outline-none  border-[#0079B0] text-[#0079B0] w-24 py-1'>1</button>
                            <button type={'button'} onClick={() => {
                                increament()
                                option_1()
                            }} className='border-2 rounded-xl outline-none  border-[#0079B0] text-[#0079B0] w-24 py-1'>2</button>
                            <button type={'button'} onClick={() => {
                                increament()
                                option_2()
                            }} className='border-2 rounded-xl outline-none  border-[#0079B0] text-[#0079B0] w-24 py-1'>3</button>
                        ...
                        <div className='space-x-2 py-1 w-full items-center flex justify-center'>
                            <button type={'button'} onClick={() => {
                                increament()
                                option_3()
                            }} className='border-2 rounded-xl outline-none  border-[#0079B0] text-[#0079B0] w-24 py-1'>4</button>
                            <button type={'button'} onClick={() => {
                                increament()
                                option_4()
                            }} className='border-2 rounded-xl outline-none  border-[#0079B0] text-[#0079B0] w-24 py-1'>5</button>
                            <button type={'button'} onClick={() => {
                                increament()
                                option_5()
                            }} className='border-2 rounded-xl outline-none  border-[#0079B0] text-[#0079B0] w-24 py-1'>6</button>
