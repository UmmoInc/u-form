...
export default function Header_sm() {
  ...
  return (
    <div className='relative w-full flex'>
      ...
      <div className='bg-[#0079B0] w-full h-[50px] justify-center px-4 grid grid-cols-3 grid-flow-row items-center'>
          <div >
          ...
          <div className='flex justify-center'>
            <Image src={Logo} width={30} alt='u-Form Logo' priority={true}/>
          </div>
      </div>
    </div>
